...
const CartIcon: FC<CartProps> = ({ width, height, fill, stroke }) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={width} height={height} fill={fill} stroke={stroke} strokeWidth="2">
